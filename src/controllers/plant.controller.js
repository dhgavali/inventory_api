...
const getPlants = catchAsync(async (req, res) => {
  ...
  res.status(httpStatus.OK).send(ApiResponse.success(httpStatus.OK, 'Plants fetched successfully', result));
});
...
const getPlant = catchAsync(async (req, res) => {
  ...
  res.status(httpStatus.OK).send(ApiResponse.success(httpStatus.OK, 'Plant fetched successfully', plant));
});
...
const updatePlant = catchAsync(async (req, res) => {
  ...
  res.status(httpStatus.OK).send(ApiResponse.success(httpStatus.OK, 'Plant updated successfully', plant));
});

const deletePlant = catchAsync(async (req, res) => {
  await plantService.deletePlantById(req.params.plantId);
  res.status(httpStatus.NO_CONTENT).send(ApiResponse.success(httpStatus.NO_CONTENT, 'Plant deleted successfully'));
});
